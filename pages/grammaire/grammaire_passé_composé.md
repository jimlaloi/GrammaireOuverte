...
Le participe passé des verbes réguliers avec une terminaison infinitive en **-re** se forme en remplaçant le **-re** final de l'infinitif par **-u**. Par exemple, le participe passé de **perdre** est **perdu**.

| perdre |
| j'ai perdu | nous avons perdu |
| tu as perdu | vous avez perdu |
| il/elle/on a perdu | ils/elles ont perdu |
...
* venir (venu), devenir (devenu), revenir (revenu), naître (né), mourir (mort)
...
### forme
Au passé composé, les verbes pronominaux sont conjugués avec **être** comme auxiliaire. Les participes passés des verbes pronominaux se forment comme des participes passés non pronominaux. Notez que le pronom réfléchi (**me**, **te**, **se**, **nous**, **vous**, **se**) précède l'auxiliaire.
