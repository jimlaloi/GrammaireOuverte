...
* *avoir* (<ins>eu</ins>), *être* (<ins>été</ins>), *faire* (<ins>fait</ins>), *ouvrir* (<ins>ouvert</ins>), *prendre* (<ins>pris</ins>), *mettre* (<ins>mis</ins>), *suivre* (<ins>suivi</ins>), *boire* (<ins>bu</ins>), *croire* (<ins>cru</ins>), *voir* (<ins>vu</ins>), *savoir* (<ins>su</ins>), *connaître* (<ins>connu</ins>), *dire* (<ins>dit</ins>), *lire* (<ins>lu</ins>), *écrire* (<ins>écrit</ins>), *pouvoir* (<ins>pu</ins>), *vouloir* (<ins>voulu</ins>), *devoir* (<ins>dû</ins>), *tenir* (<ins>tenu</ins>), *recevoir* (<ins>reçu</ins>), *naître* (<ins>né</ins>), *mourir* (<ins>mort</ins>), *venir* (<ins>venu</ins>)
...
| il est allé<br/>elle est allée<br/>on est allé(e)(s) | ils sont allés<br/>elles sont allées |
