...
keywords: participes, participles, participe, participe présent, participe passé, participe passif
summary: ""
...
Le participe passé est aussi utilisé dans la construction passive avec le verbe *être* (voir [Verbes](/grammaire_verbes.html#alternances-de-valence)).

{% include callout.html content="Regardez, le bas de nos jambes est **masqué** par les couvertures." type="primary" %}
...
{% include callout.html content="Je gagnais ma vie **en étant payé** directement.<br/><br/>**Ayant reçu** ces informations, je retire l'amendement." type="primary" %}
...
{% include callout.html content="C'est une occasion **perdue**.<br/><br/>Je n'aime pas les volets **fermés**." type="primary" %}
