...
{% include callout.html content="Je crois qu'il **va pleuvoir** demain.<br/><br/>Je **vais aller** un peu plus loin." type="primary" %}
...
{% include callout.html content="Fais attention où tu marches, tu **vas casser** quelque chose&nbsp;!" type="primary" %}
...
{% include information.html content="Notez que le **e** de l'infinitif change de prononciation dans la conjugaison au futur des verbes réguliers en **-er**, pour devenir en *e caduc*&nbsp;:<br/>nager [naʒe]<br/>nagera [naʒəʁa]/[naʒʁa]" %}
...
* *je netto<ins>i</ins>erai*, *tu netto<ins>i</ins>eras*, *il netto<ins>i</ins>era*, *nous netto<ins>i</ins>erons*, *vous netto<ins>i</ins>erez*, *ils netto<ins>i</ins>eront*
* *j'essu<ins>i</ins>erai*, *tu essu<ins>i</ins>eras*, *il essu<ins>i</ins>era*, *nous essu<ins>i</ins>erons*, *vous essu<ins>i</ins>erez*, *ils essu<ins>i</ins>eront*

Les autres changements d'orthographe qui affectent les radicaux au présent des verbes en *-é\_er* (comme *préférer*), *-ger* (comme *voyager*), et *-cer* (comme *commencer*) n'affectent pas le radical du futur.
...
Le futur est nécessaire dans des propositions subordonnées commençant par **dès que**, **aussitôt que**, **lorsque** et **quand**. Notez que les équivalents anglais sont typiquement suivis du présent&nbsp;:
...
L'action dans la proposition subordonnée implique le futur puisqu'elle aura lieu à peu près en même temps que l'action dans la proposition principale. Le futur périphrastique apparaît parfois après ces conjonctions, mais le futur simple est plus commun dans ce contexte.
...
{% include image.html file="futur_futurAntérieurFriseChronologique.png" alt="Futur antérieur avant un point de référence au futur" caption="Le sens antérieur du futur antérieur" %}
