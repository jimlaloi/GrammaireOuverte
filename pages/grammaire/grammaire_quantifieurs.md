...
{% include information.html content="Dans un registre formel, il est possible de modifier un nom commun avec **tout** sans article&nbsp;: *Comme **tout commerçant**, le vendeur a une obligation en cas de vice caché.*" %}
...
{% include callout.html content="**La majorité** des victimes **sont** des civils.<br/><br/>**La moitié** des enfants handicapés n'**a** pas accès à la même école que les autres enfants." type="primary" %}
...
+ **n'importe qui** 'anybody/anyone', 'whoever/whomever'
+ **n'importe quoi** 'anything', 'whatever'
+ **n'importe quel** 'whichever'
+ **n'importe lequel** 'whichever of them'
