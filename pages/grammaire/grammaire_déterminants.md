...
+ pour un nom exprimant une catégorie entière ou un concept général
...
+ avec des moments de la journée, des jours de la semaine et des saisons pour indiquer la récurrence habituelle
...
{% include information.html content="L'article est généralement répété dans une série de noms, contrairement à l'anglais. Par exemple: *Il enregistre **les** appels, **les** e-mails, et **les** SMS.*" type="primary" %}
...
{% include callout.html content="Donne-moi la main et pose tes pieds exactement où je pose **les miens**." type="primary" %}

+ nom + *à* + possesseur

{% include callout.html content="C'est arrivé à une amie **à moi**." type="primary" %}

+ nom + *de* + possesseur

{% include callout.html content="La maison **de Jean** était très jolie." type="primary" %}
