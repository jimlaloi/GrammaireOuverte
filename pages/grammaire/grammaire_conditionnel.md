...
## Introduction
Le conditionnel est utilisé pour désigner des événements hypothétiques. Cela se produit dans les demandes polies et le plus souvent avec les propositions avec **si**. Le conditionnel est le plus souvent traduit par « would » en anglais.

### forme
Le radical utilisé pour former le conditionnel est le même que le radical du futur (généralement l'infinitif). Les terminaisons du conditionnel sont **-ais**, **-ais**, **-ait**, **-ions**, **-iez**, **-aient** (Ce sont aussi les terminaisons de l'imparfait).
...
Cette forme s'applique aux verbes en **-er** (aimer, j'aimer**ais**), en **-ir** (finir, je finir**ais**), et en **-re** (vendre, je vendr**ais**). N'oubliez pas de supprimer le **e** final du radical infinitif des verbes en **-re**.

### prononciation
Le **r** dans le radical est représentatif du conditionnel, ainsi que du futur. Seule la différence dans la prononciation des terminaisons distingue les deux. La différence entre les formes **je** est subtile. Notez également comment la prononciation du **e** de l'infinitif des verbes en **-er** change dans les formes du futur et du conditionnel.

| regarder |
| futur | conditionnel |
| je regarder**ai** | je regarder**ais** |
| tu regarder**as** | tu regarder**ais** |
| il/elle/on regarder**a** | il/elle/on regarder**ait** |
| nous regarder**ons** | nous regarder**ions** |
| vous regarder**ez** | vous regarder**iez** |
| ils/elles regarder**ont** | ils/elles regarder**aient** |
...
### verbes avec des changements d'orthographe
Certains verbes dont l'orthographe change au présent ont néanmoins une forme régulière du radical au futur et au conditionnel. Cela inclut des verbes comme **préférer**, **espérer**, **manger**, et **commencer**.

| infinitif | radical | conditionnel |
| préférer | préférer- | je préférerais |
| espérer | espérer- | j'espérerais |
| manger | manger- | je mangerais |
| commencer | commencer- | je commencerais |

D'autres verbes avec des changements d'orthographe, comme **appeler**, **employer**, et **acheter**, ajoutent **-r** à la forme **je** du présent pour créer le radical du futur et du conditionnel.

| présent | radical | conditionnel |
| j'appelle | appeller- | j'appellerais |
| j'emploie | emploier- | j'emploierais |
| j'achète | achèter- | j'achèterais |
...
### forme
Le passé du conditionnel est un temps composé, c'est-à-dire qu'il a deux parties, un auxiliaire et le participe passé. Le passé du conditionnel est formé avec le conditionnel de l'auxiliaire (soit **avoir** ou **être**) et le participe passé du verbe principal.
...
Au passé du conditionnel (comme au passé composé), il faut choisir entre **avoir** et **être** comme auxiliaire. Tout comme pour le passé composé avec **être**, au passé du conditionnel avec **être**, le participe passé s'accorde en genre et en nombre avec le sujet.
