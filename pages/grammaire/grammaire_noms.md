...
Un nom est essentiellement une étiquette pour des lieux, des choses, des évènements, des idées, des concepts et ainsi de suite. Comme en anglais, les noms en français peuvent être catégorisés comme communs ou propres, dénombrables ou indénombrables, singuliers ou pluriels. Cependant, contrairement à l'anglais, les noms en français sont aussi catégorisés comme masculins ou féminins.

### commun ou propre 

Les noms communs en anglais et en français sont le terme générique pour quelque chose. Les noms communs ne prennent une majuscule qu'en début de phrase.

* un **tatou**

Les noms propres sont des noms spécifiques et prennent donc une majuscule.

* **Tex** et **Tammy**

### dénombrable ou indénombrable

Un autre moyen de classifier les noms dépend de si l'on peut les compter ou non. Les noms dénombrables identifient des entités individuelles que l'on peut compter, comme les tatous.

* un **tatou**, deux **tatous**

Par contre, un nom indénombrable signifie une entité comme une unité que l'on ne peut compter. Dans l'exemple suivant, le pain que Tex mange est conçu comme une quantité indéfinie et donc indénombrable.

* Tex mange du **pain**.

La différence entre les noms dénombrables et indénombrables est typiquement très claire. Cependant, quelque chose qui est typiquement dénombrable comme un animal (un tatou, deux tatous, trois tatous) peut néanmoins être conçu en termes indénombrable, comme dans cet exemple désagréable:
...
Les noms indénombrables n'ont typiquement qu'une forme singulière. Essayez de dire la forme plurielle des noms indénombrables anglais suivants:
...
### noms en -s, -x, -z au singulier 

Les noms en **-s**, **-x**, ou **-z** ne changent pas au pluriel. Par exemple: 

* Tex a un long **nez**. Les tatous ont toujours de longs **nez**. Joe-Bob est un **écureuil**. Les **écureuils** adorent les **noix**. Joe-Bob mange au moins une **noix** par jour. Bette est une chatte. Les chats mangent des **souris**. Est-ce que Bette a jamais mangé une **souris**? 

### noms en -al, -ail, -au, -eu, -eau, -ou au singulier
...
* Edouard n'a pas un seul **cheveu**. Bien sûr, c'est un escargot! Mais Tammy a les **cheveux** longs. C'est une tatou extraordinaire! 
...
Les exception incluent: un clou, des **clous*; un sou, des *sous*; un trou, des **trous**. 

### pluriels irréguliers 

Certains noms ont une autre forme au pluriel: 
...
Notez que certains noms suivent la règle normale pour la forme écrite du pluriel mais ont une prononciation différente au pluriel. Par exemple, le **-f** est prononcé au singulier, mais pas au pluriel.
...
* Tex et Rita sont frère et soeur, mais ils ont des métiers tout à fait différents.
...
|-|-|
| le from**age** | la sal**ade** |
| le monu**ment** | la fourch**ette** |
| le senti**ment** | la télévi**sion** |
| le cout**eau** | la cult**ure** |
| le télé**phone** | la situa**tion** |
| le micro**scope** | la socié**té** |
